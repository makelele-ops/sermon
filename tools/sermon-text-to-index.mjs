...
function classifySection(section) {
  ...
  if (hasAny(text, ["롱런하려면 하나님의 은혜", "하나님의 은혜를 잊지 말아야", "은혜를 잊지 말라"])) return "graceLongRun";
  if (hasAny(text, ["롱런하려면 사람을 사랑", "사람을 품는 품이 넓어", "사람을 사랑하라"])) return "loveLongRun";
  if (hasAny(text, ["롱런하려면 주님의 발치", "주님의 발치로 돌아와야", "주님의 발치에 돌아오라"])) return "restLongRun";
...
function profileReference(profile, variant = 0) {
  const table = {
    graceLongRun: [
      "누가복음 10:21, 고린도전서 15:10, 사무엘상 17:47",
      "누가복음 10:21, 이사야 40:13"
    ],
    loveLongRun: [
      "누가복음 10:25-29",
      "누가복음 10:30-37, 마태복음 9:36"
    ],
    restLongRun: [
      "누가복음 10:38-40",
      "누가복음 10:41-42, 시편 23:1-4"
    ],
    sentVictory: [
...
function dayTitle(section, profile, variant) {
  ...
  const table = {
    graceLongRun: ["은혜를 잊지 말라", "어린아이처럼 은혜를 구하다"],
    loveLongRun: ["사랑의 질문 앞에 서다", "불쌍히 여기는 마음"],
    restLongRun: ["분주함에서 발치로", "주님을 놓치지 말라"],
...
function dayNavTitle(section, profile, variant) {
  const title = cleanTitle(section.title);
  const table = {
    graceLongRun: ["하나님께서 하셨습니다", "받아야 사는 마음"],
    loveLongRun: ["내 이웃은 누구입니까", "누구의 이웃이 될까"],
    restLongRun: ["분주함 속의 마르다", "한 가지면 족하다"],
...
function dayVerse(focusText, profile, title, variant = 0) {
  ...
  const table = {
    graceLongRun: [
      ...
      "지혜롭고 슬기 있는 자들에게는 숨기시고 어린아이들에게는 나타내심을 감사하나이다"
    ],
    loveLongRun: [
      "네 마음을 다하며 네 목숨을 다하며 네 힘을 다하며 네 뜻을 다하여 주 너의 하나님을 사랑하고 또한 네 이웃을 네 자신 같이 사랑하라",
...
function readingText(section, profile, variant) {
  ...
  const curated = {
    graceLongRun: [
      "칠십 인이 놀라운 일을 하고 돌아왔지만 예수님은 제자들의 능력을 칭찬하기보다 하나님의 은혜를 말씀하셨습니다. 내가 잘해서가 아니라 하나님께서 하셨음을 기억하는 사람이 한 번의 승리와 박수를 넘어 오래도록 믿음의 길을 갑니다.",
      "은혜를 아는 신앙을 오래 유지하려면 어린아이의 마음을 가져야 합니다. 어린아이는 받아야 살 수 있듯이 우리도 ‘나는 주님의 은혜가 필요합니다’라고 고백해야 합니다. 스스로 충분하다고 여기지 않고 날마다 은혜를 구하는 사람이 롱런합니다."
    ],
    loveLongRun: [
      "율법 교사는 영생의 길이 하나님을 사랑하고 이웃을 사랑하는 것임을 알았습니다. 그러나 그는 ‘내 이웃이 누구입니까?’라고 다시 물었습니다. 예수님은 이 질문을 통해 우리가 사랑의 대상을 정하고 경계를 긋고 있지는 않은지 돌아보게 하십니다.",
      "예수님은 선한 사마리아인의 이야기로 질문을 바꾸셨습니다. ‘누가 내 이웃인가?’가 아니라 ‘나는 누구의 이웃이 되어 주었는가?’입니다. 사마리아인은 강도 만난 사람을 보고 불쌍히 여겼기에 다가가 도왔습니다. 사람을 불쌍히 여기고 실제로 사랑하는 것이 행복하게 롱런하는 비결입니다."
    ],
    restLongRun: [
      "마르다는 예수님을 기쁘게 영접한 선하고 헌신적인 사람이었습니다. 그러나 접대할 일이 많아 분주해지자 주님의 발치에 앉은 마리아를 보고 화가 났고 예수님께 항의했습니다. 좋은 섬김도 주님보다 커지면 마음의 평안을 잃을 수 있습니다.",
      "마르다의 문제는 섬김 자체가 아니라 주님을 섬기면서 주님을 놓친 것이었습니다. 평안을 잃자 비교하고 마침내 원망했습니다. 주님은 한 가지만으로도 족하니 자신을 놓치지 말라고 하십니다. 유한한 세상의 박수보다 영원한 주님의 음성을 사모할 때 행복하게 롱런할 수 있습니다."
    ],
    sentVictory: [
...
function prayerText(profile, title, variant = 0) {
  const table = {
    graceLongRun: [
      "주님, 한 번의 승리와 박수에 머물지 않고 모든 일을 하나님께서 하셨음을 기억하며 은혜 안에서 오래도록 믿음의 길을 걷게 하옵소서.",
      "하나님, 스스로 충분하다고 여기지 않고 어린아이처럼 날마다 주님의 은혜가 필요하다고 겸손히 고백하게 하옵소서."
    ],
    loveLongRun: [
      "예수님, 누가 사랑받을 자격이 있는지 경계를 긋지 않고 하나님을 사랑하며 이웃을 제 자신처럼 사랑하게 하옵소서.",
      "주님, ‘누가 내 이웃인가’만 묻지 않고 고통받는 사람을 불쌍히 여기며 먼저 다가가 그의 이웃이 되어 주게 하옵소서."
    ],
    restLongRun: [
      "주님, 좋은 뜻으로 섬기면서도 분주함에 사로잡혀 평안을 잃지 않게 하시고 다시 주님의 발치에 앉게 하옵소서.",
      "예수님, 주님을 섬기면서 정작 주님을 놓치지 않게 하시고 유한한 세상보다 영원한 주님의 음성을 사모하게 하옵소서."
    ],
    sentVictory: [
...
function actionText(profile, title, variant = 0) {
  const table = {
    graceLongRun: [
      ...
      "혼자 힘으로 충분하다고 여긴 일을 적고, ‘주님, 오늘도 은혜가 필요합니다’라고 어린아이처럼 기도합니다."
    ],
    loveLongRun: [
      "내가 무심코 사랑의 경계를 그은 사람 한 명을 떠올리고, 그를 이해하기 위한 작은 질문을 건넵니다.",
      "오늘 도움이 필요한 한 사람을 살피고, 불쌍히 여기는 마음으로 작은 친절 한 가지를 실제로 건넵니다."
    ],
    restLongRun: [
      "분주함 때문에 평안을 잃은 일을 잠시 내려놓고 10분 동안 주님의 발치에 앉듯 말씀 앞에 머뭅니다.",
      "비교와 원망이 생긴 섬김을 돌아보고, 오늘 가장 먼저 붙들 주님의 한 말씀을 적어 마음에 새깁니다."
    ],
    sentVictory: [
...
function familyQuestionText(profile, title, variant = 0) {
  const table = {
    graceLongRun: [
      ...
      "우리 가족이 어린아이처럼 ‘주님의 은혜가 필요합니다’라고 함께 고백할 일은 무엇일까요?"
    ],
    loveLongRun: [
      "우리 가족이 ‘내 이웃은 누구인가’라고 경계를 그었던 사람은 누구일까요?",
      "우리 가족이 이번 주 불쌍히 여기며 먼저 다가가 이웃이 되어 줄 사람은 누구일까요?"
    ],
    restLongRun: [
      "우리 가족이 분주함을 멈추고 함께 주님의 발치에 앉아야 할 시간은 언제일까요?",
      "우리 가족이 주님을 섬기면서도 주님을 놓치지 않기 위해 한 가지로 집중할 것은 무엇일까요?"
    ],
    sentVictory: [
...
function prompts(profile, title, variant = 0) {
  const table = {
    graceLongRun: [
      ...
      ["나는 오늘도 주님의 은혜가 필요하다고 어린아이처럼 고백하고 있나요?", "충분하다는 마음 내려놓기", "은혜 구하기", "받은 은혜 감사하기"]
    ],
    loveLongRun: [
      ["나는 ‘누가 내 이웃인가’라고 물으며 사랑의 경계를 정하고 있지는 않나요?", "경계 돌아보기", "하나님 사랑하기", "이웃 사랑하기"],
      ["나는 오늘 누구의 이웃이 되어 줄 수 있을까요?", "고통 바라보기", "불쌍히 여기기", "먼저 다가가기"]
    ],
    restLongRun: [
      ["좋은 뜻으로 섬기면서도 분주함 때문에 평안을 잃은 자리는 어디인가요?", "분주함 멈추기", "마음 살피기", "주님의 발치에 앉기"],
      ["나는 주님을 섬기면서 정작 주님을 놓치고 있지는 않나요?", "비교 내려놓기", "원망 내려놓기", "영원한 말씀 사모하기"]
    ],
    sentVictory: [
